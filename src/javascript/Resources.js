...
import introStaticENGSource from '../models/intro/static/ENG.png'
import introStaticFRSource from '../models/intro/static/FR.png'

import introInstructionsArrowsSource from '../models/intro/instructions/arrows.png'
import introInstructionsArrowsFRSource from '../models/intro/instructions/arrowsFR.png'
import introInstructionsControlsSource from '../models/intro/instructions/controls.png'
import introInstructionsControlsFRSource from '../models/intro/instructions/controlsFR.png'
...
import introInstructionsOtherFRSource from '../models/intro/instructions/otherFR.png'
...
// TechWatch
import techwatchStaticBaseSource from '../models/techwatch/static/base.glb'
import techwatchStaticCollisionSource from '../models/techwatch/static/collision.glb'
import techwatchStaticFloorShadowSource from '../models/techwatch/static/floorShadow.png'

import techwatchIntroSource from '../models/techwatch/static/intro.png'
import techwatchTheme1Source from '../models/techwatch/static/theme1.png'
import techwatchTheme2Source from '../models/techwatch/static/theme2.png'
import techwatchTheme3Source from '../models/techwatch/static/theme3.png'

import techwatchIntroSourceFR from '../models/techwatch/static/introFR.png'
import techwatchTheme1SourceFR from '../models/techwatch/static/theme1FR.png'
import techwatchTheme2SourceFR from '../models/techwatch/static/theme2FR.png'
import techwatchTheme3SourceFR from '../models/techwatch/static/theme3FR.png'

import techwatchToolsSource from '../models/techwatch/static/tools.png'
import techwatchToolsSourceFR from '../models/techwatch/static/toolsFR.png'
...
import projectsKlabFloorSourceFR from '../models/projects/klab/floorTextureFR.png'

import projectsPlageFloorSource from '../models/projects/plage/floorTexture.png'
import projectsPlageFloorSourceFR from '../models/projects/plage/floorTextureFR.png'

import projectsProcyonFloorSource from '../models/projects/procyon/floorTexture.png'
import projectsProcyonFloorSourceFR from '../models/projects/procyon/floorTextureFR.png'

import projectsSwitchedFloorSource from '../models/projects/switched/floorTexture.png'
import projectsSwitchedFloorSourceFR from '../models/projects/switched/floorTextureFR.png'
...
import informationActivitiesFRSource from '../models/information/static/activitiesFR.png'
    ...
    constructor()
    {
        ...
        if (localStorage.getItem('lng') == 'FR') {
            this.loader.load([
                ...
                { name: 'introStaticFR', source: introStaticFRSource, type: 'texture' },
                { name: 'introStaticENG', source: introStaticENGSource, type: 'texture' },
    
                { name: 'introInstructionsLabels', source: introInstructionsLabelsSource },
                { name: 'introInstructionsArrows', source: introInstructionsArrowsFRSource, type: 'texture' },
                { name: 'introInstructionsControls', source: introInstructionsControlsFRSource, type: 'texture' },
                { name: 'introInstructionsOther', source: introInstructionsOtherFRSource, type: 'texture' },
                ...
                // TechWatch
                { name: 'techwatchStaticBase', source: techwatchStaticBaseSource },
                { name: 'techwatchStaticCollision', source: techwatchStaticCollisionSource },
                { name: 'techwatchStaticFloorShadow', source: techwatchStaticFloorShadowSource, type: 'texture' },
                
                { name: 'techwatchIntro', source: techwatchIntroSourceFR, type: 'texture' },
                { name: 'techwatchTools', source: techwatchToolsSourceFR, type: 'texture' },
                { name: 'techwatchTheme1', source: techwatchTheme1SourceFR, type: 'texture' },
                { name: 'techwatchTheme2', source: techwatchTheme2SourceFR, type: 'texture' },
                { name: 'techwatchTheme3', source: techwatchTheme3SourceFR, type: 'texture' },
                ...
                { name: 'projectsProcyonFloor', source: projectsProcyonFloorSourceFR, type: 'texture' },
                { name: 'projectsSwitchedFloor', source: projectsSwitchedFloorSourceFR, type: 'texture' },
                { name: 'projectsKlabFloor', source: projectsKlabFloorSourceFR, type: 'texture' },
                { name: 'projectsPlageFloor', source: projectsPlageFloorSourceFR, type: 'texture' },
                ...
                { name: 'informationActivities', source: informationActivitiesFRSource, type: 'texture' },
        ...
        // English
            ...
            this.loader.load([
                ...
                { name: 'techwatchIntro', source: techwatchIntroSource, type: 'texture' },
                { name: 'techwatchTools', source: techwatchToolsSource, type: 'texture' },
                { name: 'techwatchTheme1', source: techwatchTheme1Source, type: 'texture' },
                { name: 'techwatchTheme2', source: techwatchTheme2Source, type: 'texture' },
                { name: 'techwatchTheme3', source: techwatchTheme3Source, type: 'texture' },
